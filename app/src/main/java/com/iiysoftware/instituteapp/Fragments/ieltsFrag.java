 ...
 */
public class ieltsFrag extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        save=(Button)view.findViewById(R.id.save_ielts_att_btn);
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                if (sub.equals("IELTS(ACADEMIC)") && status.equals("Running")){
                ...
                new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        db.collection("Attendance").document(formattedDate)
                                .collection("IELTS").document("List")
