 ...
 */
public class spokenFrag extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        save=(Button)view.findViewById(R.id.save_spoken_att_list);
        save.setOnClickListener(this);

        recyclerView=(RecyclerView)view.findViewById(R.id.spoken_list);
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                if (sub.equals("SPOKEN") && status.equals("Running")){
                ...
                new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        db.collection("Attendance").document(formattedDate)
                                .collection("Spoken English").document("List")
