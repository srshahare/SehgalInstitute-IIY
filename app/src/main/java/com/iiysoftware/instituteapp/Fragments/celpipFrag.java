...
import com.iiysoftware.instituteapp.mainlayout;
import com.iiysoftware.instituteapp.myAttendance;
import com.iiysoftware.instituteapp.recyclerAdapter;
 ...
 */
public class celpipFrag extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_celpip, container, false);

        save=(Button)view.findViewById(R.id.save_celpip_att_btn);
        save.setOnClickListener(this);

        recyclerView=(RecyclerView)view.findViewById(R.id.celpip_list);
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                if (sub.equals("Celpip") && status.equals("Running")){
                ...
                new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        db.collection("Attendance").document(formattedDate)
                                .collection("Celpip").document("List")
