...
public class ieltsact extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ieltsact);

        recyclerView = (RecyclerView) findViewById(R.id.recyclerView);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager( new LinearLayoutManager(this));
        youtubeVideos.add( new utubevidone("<iframe width=\"100%\" height=\"100%\" src=\"https://www.youtube.com/embed/2h1siL8CTyM\" frameborder=\"0\" allowfullscreen></iframe>") );

        utubeadaptertwo videoAdapter = new utubeadaptertwo(youtubeVideos);

        recyclerView.setAdapter(videoAdapter);

        Toolbar toolbar = findViewById(R.id.note_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("IELTS");
