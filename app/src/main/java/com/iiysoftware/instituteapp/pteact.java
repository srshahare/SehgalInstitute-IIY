...
public class pteact extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pteact);

        recyclerView = (RecyclerView) findViewById(R.id.recyclerView);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager( new LinearLayoutManager(this));

        youtubeVideos.add( new utubevidone("<iframe width=\"100%\" height=\"100%\" src=\"https://www.youtube.com/embed/ZK9dtkEsZMMw\" frameborder=\"0\" allowfullscreen></iframe>") );

        utubeadapter videoAdapter = new utubeadapter(youtubeVideos);
        ...
        getSupportActionBar().setTitle("PTE");
