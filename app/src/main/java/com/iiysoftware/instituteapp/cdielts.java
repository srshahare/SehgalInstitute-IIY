...
public class cdielts extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    Vector<utubevidone> youtubeVideos = new Vector<utubevidone>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cdielts);

        Toolbar toolbar = findViewById(R.id.note_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Celpip");
        ...
        youtubeVideos.add( new utubevidone("<iframe width=\"100%\" height=\"100%\" src=\"https://www.youtube.com/embed/UEwGpw55\" frameborder=\"0\" allowfullscreen></iframe>") );

        utubeadapterthree videoAdapter = new utubeadapterthree(youtubeVideos);
