...
public class mainlayout<mAuthListener> extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    MenuItem navManage, navPremium, navRequest, navPayment, navlogout, navlogin, contactus, myAtt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* wb=(WebView)findViewById(R.id.webview);
        ...
        wb.loadUrl("http://sehgalinstituteofenglish.com/");
        ...
        myAtt = menuNav.findItem(R.id.nav_my_att);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_login:
                Toast.makeText(mainlayout.this, "LogIn", Toast.LENGTH_SHORT).show();
            ...
            case R.id.nav_payment:
                Intent i2 = new Intent(this, payment.class);
                startActivity(i2);
                break;
            ...
            case R.id.nav_request:
                Intent i13 = new Intent(this, request.class);
                startActivity(i13);
                break;
            ...
            case R.id.nav_holidays:
                Intent intent11 = new Intent(this, Holidays.class);
                startActivity(intent11);
                break;
            case R.id.nav_booking:
                Intent intent12 = new Intent(this, ExamBooking.class);
                startActivity(intent12);
                break;
            case R.id.nav_my_att:
                Intent i14 = new Intent(this, allAttendenceList.class);
                startActivity(i14);
                break;
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (mAuth.getCurrentUser().getUid().equals("IHGjkEA8X0faYg61FE7lCzcQqL12")) {

            if (item.getItemId() == R.id.sync_item) {

                fetchallStudentBack fetchallstudentback = new fetchallStudentBack();
                fetchallstudentback.execute();

                fetchdatabackground fetchdatabackground = new fetchdatabackground();
                fetchdatabackground.execute();

                Toast.makeText(this, "database synced", Toast.LENGTH_SHORT).show();

            }
        } else {
            Toast.makeText(this, "only admin can sync database", Toast.LENGTH_SHORT).show();
